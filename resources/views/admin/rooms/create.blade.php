...
<div class="flex min-h-screen bg-[#F1EDE6]">
    ...
    <div class="flex-1 p-8 transition-all duration-300">
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-[#3A2D28] mb-2 font-serif">Create New Room Type</h1>
                ...
                <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="facilities" value="{{ old('facilities') }}" required
                                   class="w-full p-3 border border-[#A48374] rounded-lg focus:ring-2 focus:ring-[#CBAD8D] focus:border-transparent transition-all duration-200">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="3" required
                                      class="w-full p-3 border border-[#A48374] rounded-lg focus:ring-2 focus:ring-[#CBAD8D] focus:border-transparent transition-all duration-200">{{ old('description') }}</textarea>
                        </div>
